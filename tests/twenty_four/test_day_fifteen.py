...
class TestDayFifteen:
    ...
    def small_example() -> str:
        return open("inputs/twenty_four/15.example").read().strip()

    @staticmethod
    def example() -> str:
        return open("inputs/twenty_four/15.example2").read().strip()

    @staticmethod
    def real_input() -> str:
        return open("inputs/twenty_four/15.in").read().strip()
